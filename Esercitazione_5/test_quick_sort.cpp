...
int main() {
    ...
    for (int i=0; i<100; i++) {               // qui genero i 100 vettori di dimensione casuale
        ...
        quick_sort(vettore_interi, 0, vettore_interi.size()-1);                
    ...
    quick_sort(vettore_stringhe, 0, vettore_stringhe.size()-1);
    ...
    std::cout<<"Tutti i test per il Quick Sort sono passati \n";
    return EXIT_SUCCESS; 
}
