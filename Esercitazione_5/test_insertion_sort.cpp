...
int main() {
    ...
    for (int i=0; i<100; i++) {               // qui genero i 100 vettori di dimensione casuale
        ...
        insertion_sort(vettore_interi);                     // qui vado ad ordinare il vettore con il metodo bubble_sort
    ...
    insertion_sort(vettore_stringhe);
    ...
    std::cout<<"Tutti i test per l'Insertion Sort sono passati \n";
    return EXIT_SUCCESS; 
}
