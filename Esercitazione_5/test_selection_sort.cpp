...
int main() {
    ...
    for (int i=0; i<100; i++) {               // qui genero i 100 vettori di dimensione casuale
        ...
        selection_sort(vettore_interi);                     // qui vado ad ordinare il vettore con il metodo bubble_sort
    ...
    selection_sort(vettore_stringhe);
    ...
    std::cout<<"Tutti i test per il Selection Sort sono passati \n";
    return EXIT_SUCCESS;
}
