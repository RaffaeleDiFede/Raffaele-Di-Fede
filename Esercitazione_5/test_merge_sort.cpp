...
int main() {
    ...
    for (int i=0; i<100; i++) {               // qui genero i 100 vettori di dimensione casuale
        ...
        merge_sort(vettore_interi, 0, vettore_interi.size()-1);                   
    ...
    merge_sort(vettore_stringhe, 0, vettore_stringhe.size()-1);
    ...
    std::cout<<"Tutti i test per il Merge Sort sono passati \n";
    return EXIT_SUCCESS; 
}
